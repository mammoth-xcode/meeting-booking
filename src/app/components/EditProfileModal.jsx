...
import { FaBook, FaCircleExclamation, FaAddressBook, FaUserPlus, FaUserPen, FaFloppyDisk, FaArrowRotateLeft } from "react-icons/fa6";
...
const EditProfileModal = ({ isOpen, user, onClose, onSave, positions, departments, roles }) => {
  ...
  const handleSave = async () => {
    if (validate()) {
        ...
        try {
          ...
          const response = await fetch(`api/users/${user.employee_id}`, {
              method: "PUT",
              headers: {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white  px-6 py-4  rounded-lg w-96">
        <div className="container mx-auto px-0 mb-1 flex items-center justify-center">
          <FaUserPen className="text-2xl font-semibold mb-1 px-0.5 " />
          <span className="text-lg font-semibold mb-0">แก้ไขข้อมูลผู้ใช้งาน</span>
        </div>
        {/* {loading && (
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  {positionx.map((ps) => (
                    <SelectItem key={ps.position_id} value={ps.position_id}>
                      {ps.position_name}
                    </SelectItem>
                  ))}
                </SelectGroup>
            ...
            {errors.ps && <p className="text-red-500 text-sm">{errors.ps}</p>}
          </div>
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  {departmentx.map((dp) => (
                    <SelectItem key={dp.department_id} value={dp.department_id}>
                      {dp.department_name}
                    </SelectItem>
                  ))}
                </SelectGroup>
            ...
            {errors.dp && <p className="text-red-500 text-sm">{errors.dp}</p>}
          </div>
